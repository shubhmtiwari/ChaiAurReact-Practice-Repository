...
function App() {
  ...
  return (
    <>
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-oragne-500 bg-gray-800">
        <h1 className="text-white text-center my-3">Password Generator</h1>
        <div className="flex shadow rounded-lg overflow-hidden mb-4">
          <input
            type="text"
            value={password}
            className="bg-gray-300 text-white placeholder:text-gray-400 border border-gray-600 focus:outline-none w-full py-1 px-3"
          ...
          <button
            ...
            className="text-white outline-none cursor-pointer bg-blue-500 px-3 py-0.5 shringg-0"
          >
            Copy
          </button>
        </div>
